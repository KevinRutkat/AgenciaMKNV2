...
export default function TranslationLoadingIndicator() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-teal-600 to-teal-700 text-white py-1 px-4 shadow-md transition-all duration-300">
