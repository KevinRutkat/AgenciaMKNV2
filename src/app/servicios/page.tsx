...
export default function ServiciosPage() {
  ...
  // Datos de servicios inmobiliarios usando las traducciones
  ...
  // Datos de servicios de traducción usando las traducciones
  ...
  const ServiceAccordion = ({ services, icon: Icon, title, description }: {
                ...
                <ul className="space-y-2">
                  {service.details.map((detail, index) => (
                    <li key={index} className="flex items-center space-x-3">
                      <span className="text-teal-600 flex-shrink-0 w-2 h-2 bg-teal-600 rounded-full"></span>
